...
export default class OrderedObjParser {
  constructor(options, externalEntities) {
    ...
    // Live read-only proxy of matcher Ã¢â‚¬â€ PEM creates and caches this internally.
...
function buildAttributesMap(attrStr, jPath, tagName, force = false) {
  ...
  if (force === true || (options.ignoreAttributes !== true && typeof attrStr === 'string')) {
    ...
    // Hoist toString() once Ã¢â‚¬â€ path doesn't change during attribute processing
    ...
    for (let i = 0; i < len; i++) {
      ...
      if (attrName.length) {
        ...
        if (matches[i][4] !== undefined) {
          // Reuse already-processed value Ã¢â‚¬â€ no double entity replacement
