...
const htmlEntities = {
  ...
  "cent": { regex: /&(cent|#162);/g, val: "Ã‚Â¢" },
  "pound": { regex: /&(pound|#163);/g, val: "Ã‚Â£" },
  "yen": { regex: /&(yen|#165);/g, val: "Ã‚Â¥" },
  "euro": { regex: /&(euro|#8364);/g, val: "Ã¢â€šÂ¬" },
  "copyright": { regex: /&(copy|#169);/g, val: "Ã‚Â©" },
  "reg": { regex: /&(reg|#174);/g, val: "Ã‚Â®" },
  "inr": { regex: /&(inr|#8377);/g, val: "Ã¢â€šÂ¹" },
