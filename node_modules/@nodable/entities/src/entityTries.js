...
// during lookup Ã¢â‚¬â€ every key is a plain charCode number.
//
...
// Reverse map: character sequence Ã¢â€ â€™ "&name;"
const CHAR_TO_ENTITY = new Map();
for (const [name, chars] of Object.entries(ALL_ENTITIES)) {
  CHAR_TO_ENTITY.set(chars, `&${name};`);
}

export const trie1 = new Map();   // code0          Ã¢â€ â€™ entity string
export const trie2 = new Map();   // code0 Ã¢â€ â€™ Map    Ã¢â€ â€™ entity string
export const trie3 = new Map();   // code0 Ã¢â€ â€™ Map Ã¢â€ â€™ Map Ã¢â€ â€™ entity string
...
for (const [chars, entity] of CHAR_TO_ENTITY) {
  ...
  if (len === 1) {
    ...
    // (longer matches are inserted in the same pass so we just overwrite Ã¢â‚¬â€
