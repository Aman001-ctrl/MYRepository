...
export interface DescribeTenantDatabasesMessage {
    ...
    /**
     * <p>The user-supplied tenant database name, which must match the name of an existing tenant database on the specified DB instance owned by your Amazon Web Services account. This parameter isnâ€™t case-sensitive.</p>
     * @public
     */
...
export interface ModifyTenantDatabaseMessage {
    ...
    DBInstanceIdentifier: string | undefined;
    /**
     * <p>The user-supplied name of the tenant database that you want to modify. This parameter isnâ€™t case-sensitive.</p> <p>Constraints:</p> <ul> <li> <p>Must match the identifier of an existing tenant database.</p> </li> </ul>
     * @public
     */
    TenantDBName: string | undefined;
    /**
    ...
    MasterUserPassword?: string | undefined;
    /**
     * <p>The new name of the tenant database when renaming a tenant database. This parameter isnâ€™t case-sensitive.</p> <p>Constraints:</p> <ul> <li> <p>Can't be the string null or any other reserved word.</p> </li> <li> <p>Can't be longer than 8 characters.</p> </li> </ul>
     * @public
     */
...
export interface SwitchoverReadReplicaMessage {
    /**
     * <p>The DB instance identifier of the current standby database. This value is stored as a lowercase string.</p> <p>Constraints:</p> <ul> <li> <p>Must match the identiï¬er of an existing Oracle read replica DB instance.</p> </li> </ul>
     * @public
     */
    DBInstanceIdentifier: string | undefined;
}
