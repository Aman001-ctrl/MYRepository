...
/**
 * <p>The details of the DB instanceâ€™s server certificate.</p> <p>For more information, see <a href="https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/UsingWithRDS.SSL.html">Using SSL/TLS to encrypt a connection to a DB instance</a> in the <i>Amazon RDS User Guide</i> and <a href="https://docs.aws.amazon.com/AmazonRDS/latest/AuroraUserGuide/UsingWithRDS.SSL.html"> Using SSL/TLS to encrypt a connection to a DB cluster</a> in the <i>Amazon Aurora User Guide</i>.</p>
 * @public
 */
export interface CertificateDetails {
    ...
    /**
     * <p>The expiration date of the DB instanceâ€™s server certificate.</p>
     * @public
     */
...
export interface DeleteTenantDatabaseMessage {
    ...
    DBInstanceIdentifier: string | undefined;
    /**
     * <p>The user-supplied name of the tenant database that you want to remove from your DB instance. Amazon RDS deletes the tenant database with this name. This parameter isnâ€™t case-sensitive.</p>
     * @public
     */
    TenantDBName: string | undefined;
    /**
...
export interface DescribeDBSnapshotTenantDatabasesMessage {
    ...
    DBSnapshotIdentifier?: string | undefined;
    /**
     * <p>The type of DB snapshots to be returned. You can specify one of the following values:</p> <ul> <li> <p> <code>automated</code> â€“ All DB snapshots that have been automatically taken by Amazon RDS for my Amazon Web Services account.</p> </li> <li> <p> <code>manual</code> â€“ All DB snapshots that have been taken by my Amazon Web Services account.</p> </li> <li> <p> <code>shared</code> â€“ All manual DB snapshots that have been shared to my Amazon Web Services account.</p> </li> <li> <p> <code>public</code> â€“ All DB snapshots that have been marked as public.</p> </li> <li> <p> <code>awsbackup</code> â€“ All DB snapshots managed by the Amazon Web Services Backup service.</p> </li> </ul>
     * @public
     */
    SnapshotType?: string | undefined;
    /**
