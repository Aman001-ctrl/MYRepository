 ...
 *       userâ€™s access token upon successful authentication and authorization with IAM Identity Center.</p>
 *          <p>
 *             <b>API namespaces</b>
 *          </p>
 ...
 *           supports token refresh and doesnâ€™t require re-authentication, update to the latest CLI
 ...
 *           token into Amazon Web Services Auth (â€œsigv4â€) credentials for use with IAM-protected Amazon Web Services service
