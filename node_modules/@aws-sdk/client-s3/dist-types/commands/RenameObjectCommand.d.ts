 ...
 *       You can use <code>RenameObject</code> by specifying an existing objectâ€™s name as the source and the new
 ...
 *           value <code>â€˜*â€™</code> in the <code>RenameObject</code> request. Amazon S3 then returns a <code>412
