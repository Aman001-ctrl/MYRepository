...
export interface AbortMultipartUploadRequest {
     ...
     *       matches or if the multipart upload doesnâ€™t exist, the operation returns a <code>204 Success (No
...
export interface CompleteMultipartUploadRequest {
     ...
     *       specified. If the checksum type doesnâ€™t match the checksum type that was specified for the object during
     *       the <code>CreateMultipartUpload</code> request, itâ€™ll result in a <code>BadDigest</code> error. For more
     *       information, see Checking object integrity in the Amazon S3 User Guide. </p>
     * @public
     */
    ChecksumType?: ChecksumType | undefined;
    /**
     * <p> The expected total object size of the multipart upload request. If thereâ€™s a mismatch between the
...
export interface CopyObjectResult {
    ...
    /**
     * <p>The checksum type that is used to calculate the objectâ€™s checksum value. For more information, see
...
export interface CopyObjectRequest {
     ...
     *       new metadata. If this header isnâ€™t specified, <code>COPY</code> is the default behavior. </p>
     *          <p>
     ...
     *       unsupported values wonâ€™t write a destination object and will receive a <code>400 Bad Request</code>
     *       response. </p>
     ...
     *       with SSE-KMS. Specifying this header with a COPY action doesnâ€™t affect bucket-level settings for S3
     *       Bucket Key.</p>
...
export interface CreateMultipartUploadOutput {
    ...
    ChecksumAlgorithm?: ChecksumAlgorithm | undefined;
    /**
     * <p> Indicates the checksum type that you want Amazon S3 to use to calculate the objectâ€™s checksum
...
export interface CreateMultipartUploadRequest {
     ...
     *             <li>
     *                <p>
     *                   <code>id</code> â€“ if the value specified is the canonical user ID of an Amazon Web Services account</p>
     *             </li>
     *             <li>
     *                <p>
    ...
    ChecksumAlgorithm?: ChecksumAlgorithm | undefined;
    /**
     * <p>Indicates the checksum type that you want Amazon S3 to use to calculate the objectâ€™s checksum value. For
...
export interface CreateSessionRequest {
     ...
     *          <p>S3 Bucket Keys are always enabled for <code>GET</code> and <code>PUT</code> operations in a directory bucket and canâ€™t be disabled. S3 Bucket Keys aren't supported, when you copy SSE-KMS encrypted objects from general purpose buckets
     * to directory buckets, from directory buckets to general purpose buckets, or between directory buckets, through <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CopyObject.html">CopyObject</a>, <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_UploadPartCopy.html">UploadPartCopy</a>, <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-objects-Batch-Ops">the Copy operation in Batch Operations</a>, or
     *                             <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-import-job">the import jobs</a>. In this case, Amazon S3 makes a call to KMS every time a copy request is made for a KMS-encrypted object.</p>
     * @public
     */
...
export interface DeleteObjectRequest {
     ...
     *       doesnâ€™t exist, the operation returns a <code>204 Success (No Content)</code> response.</p>
     *          <note>
     *             <p>This functionality is only supported for directory buckets.</p>
     *          </note>
     * @public
     ...
     *       error. If the <code>Size</code> matches or if the object doesnâ€™t exist, the operation returns a
...
export interface ServerSideEncryptionByDefault {
     ...
     *             alias instead, then KMS resolves the key within the requesterâ€™s account. This behavior can
...
export interface ServerSideEncryptionRule {
     ...
     *                   <p>
     *                      <b>Directory buckets</b> -
     *             S3 Bucket Keys are always enabled for <code>GET</code> and <code>PUT</code> operations in a directory bucket and canâ€™t be disabled. S3 Bucket Keys aren't supported, when you copy SSE-KMS encrypted objects from general purpose buckets
     * to directory buckets, from directory buckets to general purpose buckets, or between directory buckets, through <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_CopyObject.html">CopyObject</a>, <a href="https://docs.aws.amazon.com/AmazonS3/latest/API/API_UploadPartCopy.html">UploadPartCopy</a>, <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/directory-buckets-objects-Batch-Ops">the Copy operation in Batch Operations</a>, or
     *                             <a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/create-import-job">the import jobs</a>. In this case, Amazon S3 makes a call to KMS every time a copy request is made for a KMS-encrypted object.</p>
     *                </li>
     *             </ul>
 ...
 *         ARN. If you use a KMS key alias instead, then KMS resolves the key within the requesterâ€™s account.
...
export interface CSVInput {
     ...
     *           column in an expression. You can use column position (such as _1, _2, â€¦) to indicate the column
