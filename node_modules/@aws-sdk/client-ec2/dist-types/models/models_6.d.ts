...
export interface InstanceMetadataDefaultsResponse {
     ...
     *             <li>
     *                <p>
     *                   <code>optional</code> â€“ IMDSv2 is optional, which means that you can
     *                     use either IMDSv2 or IMDSv1.</p>
     *             </li>
     *             <li>
     *                <p>
     *                   <code>required</code> â€“ IMDSv2 is required, which means that IMDSv1 is
...
export interface ModifyImageAttributeRequest {
     ...
     *         value to <code>v2.0</code>, you can't undo it. The only way to â€œresetâ€ your AMI is to create
...
export interface ModifyIpamResourceCidrRequest {
    ...
    /**
     * <p>Determines if the resource is monitored by IPAM. If a resource is monitored, the resource is discovered by IPAM and you can view details about the resourceâ€™s CIDR.</p>
     * @public
     */
...
export interface ModifyNetworkInterfaceAttributeRequest {
    /**
     * <p>Updates the ENA Express configuration for the network interface thatâ€™s attached to the
     *             instance.</p>
     * @public
     */
    EnaSrdSpecification?: EnaSrdSpecification | undefined;
    /**
     * <p>If youâ€™re modifying a network interface in a dual-stack or IPv6-only subnet, you have
