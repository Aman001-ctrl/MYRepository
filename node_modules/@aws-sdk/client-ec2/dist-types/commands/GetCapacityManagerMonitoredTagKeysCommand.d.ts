...
import type { GetCapacityManagerMonitoredTagKeysRequest, GetCapacityManagerMonitoredTagKeysResult } from "../models/models_5";
/**
 * @public
 */
...
declare const GetCapacityManagerMonitoredTagKeysCommand_base: {
    new (input: GetCapacityManagerMonitoredTagKeysCommandInput): import("@smithy/smithy-client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (...[input]: [] | [GetCapacityManagerMonitoredTagKeysCommandInput]): import("@smithy/smithy-client").CommandImpl<GetCapacityManagerMonitoredTagKeysCommandInput, GetCapacityManagerMonitoredTagKeysCommandOutput, EC2ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
