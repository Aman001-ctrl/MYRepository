...
// ---------------------------------------------------------------------------
// Character class strings Ã¢â‚¬â€ XML 1.0
//
...
// ---------------------------------------------------------------------------
// Character class strings Ã¢â‚¬â€ XML 1.1
//
...
//   These require the /u flag on the RegExp Ã¢â‚¬â€ see buildRegexes below.
//
// NameChar:
...
const nameStartChar11 =
  ':A-Za-z_' +
  '\u00C0-\u02FF' +                    // merged Ã¢â‚¬â€ 1.0 had three split ranges here
  '\u0370-\u037D' +
  ...
  '\uF900-\uFDCF' +
  '\uFDF0-\uFFFD' +
  '\u{10000}-\u{EFFFF}';     // supplementary planes Ã¢â‚¬â€ REQUIRES /u flag on RegExp
...
const nameChar11 =
  ...
  '\u00B7' +
  '\u0300-\u036F' +
  '\u0487' +                 // Combining Cyrillic Millions Sign Ã¢â‚¬â€ valid in 1.1, not 1.0
  '\u203F-\u2040';

// ---------------------------------------------------------------------------
// Regex builders
//
// XML 1.0 regexes: no flags Ã¢â‚¬â€ BMP only, standard JS regex behaviour.
// XML 1.1 regexes: /u flag Ã¢â‚¬â€ required for \u{10000}-\u{EFFFF} to match actual
...
const regexes10 = buildRegexes(nameStartChar10, nameChar10);       // no /u Ã¢â‚¬â€ BMP only
const regexes11 = buildRegexes(nameStartChar11, nameChar11, 'u');  // /u Ã¢â‚¬â€ enables \u{10000}-\u{EFFFF}
