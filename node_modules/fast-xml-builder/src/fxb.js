...
Builder.prototype.j2x = function (jObj, level, matcher, xmlVersion) {
  ...
  for (let key in jObj) {
    ...
    // attributesGroupName, "?" PI tags) are exempt Ã¢â‚¬â€ they are builder-internal conventions,
...
function processTextOrObjNode(object, key, level, matcher, xmlVersion) {
  ...
  // PI/XML-declaration tags must never emit text content Ã¢â‚¬â€ route through
...
Builder.prototype.buildObjectNode = function (val, key, attrStr, level) {
  if (val === "") {
    ...
    // PI/XML-declaration tags never have body content Ã¢â‚¬â€ treat them like empty.
